...
```powershell
# 1. clone
git clone https://github.com/GeorgeImanuel/generalisasi-ayam-skripsi.git
cd generalisasi-ayam-skripsi
...
@misc{generalisasi_ayam_skripsi,
  ...
  howpublished = {\url{https://github.com/GeorgeImanuel/generalisasi-ayam-skripsi}}
}
```
